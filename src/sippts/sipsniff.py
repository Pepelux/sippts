                        ...
                        try:
                            ...
                            if headers:
                                ...
                                for header in headers:
                                    m = re.search(
                                        r'^Via:\s.*\s([0-9]+\.[0-9]+\.[0-9]+\.[0-9]+).*', header)
                                    if m:
                                        ipfound = '%s' % (m.group(1))
                                        if self.verbose == 1:
                                    ...
                                    m = re.search(
                                        r'^Route:\s\<sip:([0-9]+\.[0-9]+\.[0-9]+\.[0-9]+).*', header)
                                    if m:
                                        ipfound = '%s' % (m.group(1))
                                        if self.verbose == 1:
                                    ...
                                    m = re.search(
                                        r'^Record-Route:\s\<sip:([0-9]+\.[0-9]+\.[0-9]+\.[0-9]+).*', header)
                                    if m:
                                        ipfound = '%s' % (m.group(1))
                                        if self.verbose == 1:
                                            print(
